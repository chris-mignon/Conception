...
<?php
$query = mysqli_query($conn,"select * from student LEFT JOIN class ON student.class_id = class.class_id LEFT JOIN student_status on student.status = student_status.status_id where student.status ='2'  ORDER BY student.student_id") or die(mysqli_error());
