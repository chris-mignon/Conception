	...
	while ($row = mysqli_fetch_array($query)) {
		...
		<td width="30"><a href="edit_student.php<?php echo '?id='.$id; ?>" data-toggle = "modal" class="btn btn-success"><i class="icon-pencil"></i> </a></td>
