...
<?php
$query = mysqli_query($conn,"select * from student LEFT JOIN class ON student.class_id = class.class_id LEFT JOIN student_status on student.status = student_status.status_id where student.status = '1' ") or die(mysqli_error());
