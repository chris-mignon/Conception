...
<?php 
$query_reg_teacher = mysqli_query($conn,"select * from teacher where teacher_status = '1' ")or die(mysqli_error());
...
<div class="chart-bottom-heading"><strong>Active Teacher</strong>
