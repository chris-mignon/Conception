...
<a class="brand" href="#">Welcome to: Conception Teacher panel</a>
<div class="nav-collapse collapse">
<ul class="nav pull-right">
<?php $query= mysqli_query($conn,"select users.firstname, users.lastname, teacher.user_id from users LEFT JOIN teacher on users.user_id = teacher.user_id where users.user_id = '$session_id'")or die(mysqli_error());
