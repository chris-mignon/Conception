...
<?php
$query_announcement = mysqli_query($conn,"select * from message_sent LEFT JOIN users ON users.user_id = message_sent.reciever_id where  sender_id = '$session_id'  order by date_sent DESC ")or die(mysqli_error());					
