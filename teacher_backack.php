...
<div class="span12">
<?php
$query_backpack = mysqli_query($conn,"select * FROM teacher_backpack left join teacher on teacher_backpack.teacher_id = teacher.teacher_id  where teacher.user_id = '$session_id'  order by fdatein DESC ")or die(mysqli_error());
...
<tbody>
<?php
$query = mysqli_query($conn,"select * FROM teacher_backpack left join teacher on teacher_backpack.teacher_id = teacher.user_id where teacher.user_id = '$session_id'  order by fdatein DESC")or die(mysqli_error());
