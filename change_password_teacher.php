                     ...
                     <div class="row-fluid">
                        ...
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
								...
								<?php
								$query = mysqli_query($conn,"select users.firstname, users.lastname, teacher.user_id from users LEFT JOIN teacher on users.user_id = teacher.user_id where users.user_id = '$session_id'")or die(mysqli_error());
